...
List<PodCastModel> podCastList = [
  PodCastModel(
      id: 1,
      bannerUrl: Assets.images.podcastsPicture1.image(
        fit: BoxFit.cover
      ),
      imageUrl: "https://digiato.com/wp-content/uploads/2021/02/1-30.jpg",
      name: "نیکان",
  ...
  PodCastModel(
      id: 2,
      bannerUrl: Assets.images.podcastsPicture2.image(
        fit: BoxFit.cover
      ),
      imageUrl:
          "https://digiato.com/wp-content/uploads/2022/02/10897985_639437109516078_4342420382567329691_n-300x300.jpg",
  ...
  PodCastModel(
      id: 3,
      bannerUrl: Assets.images.podcastsPicture3.image(
        fit: BoxFit.cover
      ),
      imageUrl:  "https://digiato.com/wp-content/uploads/2022/04/elon-musk-4-90x90.jpg",
      name: "گویان",
      owner: "آرش تهرانی",
      views: "798"),
  PodCastModel(
      id: 4,
      bannerUrl: Assets.images.podcastsPicture4.image(
        fit: BoxFit.cover
      ),
