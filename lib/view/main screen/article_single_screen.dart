...
class ArticleSingleScreen extends StatelessWidget {
  ...
  SingleArticleControler singleArticleControler = Get.put(SingleArticleControler());
        ...
        children: [
          Stack(
              children: [
                //poster image
                CachedNetworkImage(
                  imageUrl: singleArticleControler.articleInfoModel.value.image!,
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    //date
                    Text(
                      singleArticleControler.articleInfoModel.value.createdAt!,
